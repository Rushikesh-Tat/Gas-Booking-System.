...
<input type="radio" name="cardtype" value="credit" class="mx-3">Credit
<span class="mx-2">|</span>

<input type="radio" name="cardtype" value="debit" class="mx-3">Debit
<span class="mx-2">|</span>

<input type="radio" name="cardtype" value="cod" class="mx-3">Cash On Delivery
...
if(isset($_POST['submit']))
{
  ...
  (`bookingid`, `cardtype`, `cardno`, `nameoncard`, `expiry`, `cvv`, `amount`, `status`)
  VALUES
  ('$bookingid','$cardtype','$cardno','$nameoncard','$expiry','$cvv_enc','$amount','$status')";
